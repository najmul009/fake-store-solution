...
const searchProducts=()=>{
  ...
  const searchValue = searchfield.value.toLocaleLowerCase()
  const products = loadProducts()
  console.log(products)
  const result = products.filter(product => (product.title).toLocaleLowerCase().includes(searchValue))
  // console.log(result)
  showProducts(result)
  searchfield.value=''
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.classList.add("product",'col-sm-12','col-md-6','col-lg-4');
